# Importações importantes para que o programa funcione de forma correta
...
# Para fazermos este programa, utilizamos metodos funcoes fundamentos de POO.

# Falta documentar e explicar cada metato da classe principal PhotoOrganizer.
