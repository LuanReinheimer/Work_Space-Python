...
if peso_do_peixe > peso_regulamento:
    multa = (peso_do_peixe - 50) * multa_por_kg_excedido
    print(f'Voce tem que pagar a uma multa de R$ {multa} pelo peso excedido.')